        ...
        <div className="digital-wallet">
          <div className="title">
            ...
            <div className="left">
              ...
              <span>لیست ارزهای الکترونیک را مشاهده میکنید </span>
            </div>
          </div>
          <div className="digital-wallet-list">
            <div className="bottom">
              <div className="top">
                <div className="right">
                  <h2>لیست تراکنش های ارز الکترونیک</h2>
                </div>
...
export default Digital_Currencies;
